...
/**
 * Client that connects to the Chelava daemon via Unix Domain Socket.
 *
...
public final class DaemonClient implements AutoCloseable {
    ...
    private static final Path DEFAULT_SOCKET = Path.of(
            System.getProperty("user.home"), ".chelava", "chelava.sock");
    ...
    /**
     * Creates a client targeting the default daemon socket at {@code ~/.chelava/chelava.sock}.
     */
    public DaemonClient() {
        this(DEFAULT_SOCKET);
    }
