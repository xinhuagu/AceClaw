...
/**
 * Auto-starts the Chelava daemon if it is not already running.
 *
...
public final class DaemonStarter {
    ...
    private static final Path HOME_DIR = Path.of(System.getProperty("user.home"), ".chelava");
    private static final Path SOCKET_PATH = HOME_DIR.resolve("chelava.sock");
    ...
    private static void startDaemonProcess() throws IOException {
        ...
        ProcessBuilder pb = new ProcessBuilder(
                ...
                "--enable-preview",
                "-cp", classpath,
                "dev.chelava.daemon.ChelavaDaemon"
        );
